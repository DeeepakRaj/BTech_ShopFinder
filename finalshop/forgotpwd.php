...
<body>
	...
	<div class="wrapper" id="wrapper">
				...
				<div class="row h-100 justify-content-center align-items-center">
					<div class="col-lg-6 col-12">
						<div class="my__account__wrapper">
							<h3 class="account__title" align="center">Forgot Password</h3>
							<div class="account__form">
							     <form  method="post">
							        ...
							        <div class="form__btn2">
							            <button type="button" onclick="submit_otp()">Submit OTP</button>
							        </div>       
							    </form>
							</div>
		...
		function send_otp(){
			...
			jQuery.ajax({
				...
				success:function(result){
					if(result=='yes'){
						jQuery('.input__box2').show();
						jQuery('.form__btn2').show();
						jQuery('.input__box').hide();
						jQuery('.form__btn').hide();
		...
		<style>
		.input__box2{display:none;}
		.form__btn2{display:none;}
		.fild_error{color:red;}

		.account__form .input__box2 {
    		margin: 0 0 15px; }
