							...
							<form action = "phpShop.php" method="POST" enctype="multipart/form-data">
								<div class="account__form">
									...
									<div class="input__box">
										...
										<input type="number" minlength="10" maxlength="14" placeholder="Please include your Country Code like +91 xxxxxxxxxx" name="txtShopPhoneNumber">
									</div>
									...
									<div class="input__box">
										...
										<input type="number" maxlength="6" name="txtShopPostcode">
									...
									<div class="input__box">
										...
										<select class="select__option" name="optShopCategory">
											<?php while ($row1 = mysqli_fetch_array($shopCat)) :; ?>
												<option value="<?php echo $row1['SysId']; ?>"><?php echo $row1['CatName']; ?></option>
											<?php endwhile; ?>
