								...
								<div class="account__form">
									...
									if (mysqli_num_rows($query_run)) {
										while ($row = mysqli_fetch_array($query_run)) {
											?>
										<input type="hidden" name="shopid" value="<?php echo $row['SysId'] ?>">
											...
											<div class="input__box">
												...
												<select class="select__option" name="optShopCategory">
													...
													<?php while ($rowShopCat = mysqli_fetch_array($shopCat)) :; ?>
														<option value="<?php echo $rowShopCat['SysId']; ?>"><?php echo $rowShopCat['CatName']; ?></option>
													<?php endwhile; ?>
 ...
 <!-- Mayank Look into it  -->
											<!-- <div class="input__box">
												...
												<div class="input__box ">
													...
													<!-- <input type="text"> -->
													<input type="text" min="08:00" max="23:00" name="txtShopTiming" placeholder="8:00 AM - 8:00 PM, Mon - Sat" value="<?php echo $row['ShopOctime'] ?>">
												...
												<div class="input__box">
													...
													<select class="select__option" name="optShopDuration" value="">
												...
												<div class="form__btn" style="padding:3%" align="center">
													<button type="submit" name="btnShopUpdate" value="update" onclick="location.href='shopUpdate.php?shop_id=<?php echo $row['SysId']; ?>  ';">Update</button>
												</div>
