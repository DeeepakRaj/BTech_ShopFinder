							...
							<form action="#">
								<div class="account__form">
									<div class="input__box">
										...
										<input type="text" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
									</div>
									<div class="input__box">
										<label>Confirm Password<span>*</span></label>
										<input type="text" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>										
									</div>
									<div class="form__btn" align="center" onclick="location.href='login.php">
										
										<button name="signup">Save Changes</button>
									
										<a class="forget_pass" onclick="location.href='forgotpwd.html'" align="center">Back</a>
									</div>
