...
<body>
	...
	<!-- End Bradcaump area -->
	<!-- Start Shop Page -->
	<div class="wn__product__area brown--color pt--90  pb--30 mt--40">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-12 order-2 order-lg-3 md-mt-40 sm-mt-40">
					<div class="shop__sidebar">
						<aside class="wedget__categories poroduct--cat">
							<h3 class="wedget__title" style="text-align:center">Product Categories</h3>
							<ul>
								<li style=" text-align:center"><a href="#">Baby</a></li>
								<li style="text-align:center"><a href="#">Toys</a></li>
								<li style="text-align:center"><a href="#">Food</a></li>
								<li style="text-align:center"><a href="#">Gifts</a></li>
								<li style="text-align:center"><a href="#">footwear</a></li>
								<li style="text-align:center"><a href="#">Sports</a></li>
								<li style="text-align:center"><a href="#">Travel </a></li>
								<li style="text-align:center"><a href="#">Beauty</a></li>
								<li style="text-align:center"><a href="#">Health</a></li>
								<li style="text-align:center"><a href="#">Garden</a></li>
								<li style="text-align:center"><a href="#">Clothing </a></li>
								<li style="text-align:center"><a href="#">Automotive</a></li>
								<li style="text-align:center"><a href="#">Electronics</a></li>
								<li style="text-align:center"><a href="#">grocery store</a></li>
								<li style="text-align:center"><a href="#">Restaurants</a></li>
								<li style="text-align:center"><a href="#">department store</a></li>
							</ul>
						</aside>
