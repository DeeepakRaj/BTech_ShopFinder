				...
				<div class="row h-100 justify-content-center align-items-center">
					<div class="col-lg-6 col-12">
						<div class="my__account__wrapper">
							<h3 class="account__title" align="center">Login</h3>
							...
							<div class="form__btn">
										<!------<button onclick="location.href='reg.php'" align="center">Register Now</button>--->
										<p>Not registered yet? <a href='reg.php'>Register Here</a></p>
									</div>									
									<a class="forget_pass" onclick="location.href='forgotpwd.html'" align="center">Reset Password</a>
								</div>
						</div>
					</div>
