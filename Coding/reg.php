...
//inserting the variables into the database fields by sql query
        $query = "INSERT into `tblusertable` (Firstname, LastName, PassWord, PhoneNumber)
VALUES ('$firstname', '$lastname','$password','$phno')";
							...
							<form action="" method="post">
								<div class="account__form">
									...
									<div class="input__box">
										...
										<input type="number" name="phno" id="phno" pattern="[0-9]{10}" title="10 digit mobile number" required>
									</div>
									<div class="input__box">
