...
// $trn_date = date("Y-m-d H:i:s");
        $query = "UPDATE tblusertable SET FirstName='$firstname', LastName='$lastname', PassWord='$password', LocationId='$location', UEmail='$email', Gender='$gen' WHERE PhoneNumber='$phno'";
        $result = mysqli_query($con,$query);
        if($result){
            echo "<div class='form'>
<h3>Profile Update successfull.</h3>
				...
				<div class="row h-100 justify-content-center align-items-center">
					<div class="col-lg-6 col-12">
						<div class="my_account_wrapper">
							<h3 class="account__title" align="center">Profile Page</h3>
							<form action="" method="post">
								<div class="account__form">
									<div class="input__box">
										<label>Your Current Mobile Number<span>*</span></label>
										<input type="text" id="phno" name="phno" pattern="[0-9]{10}" title="10 digit mobile number" required>
									</div>
									<div class="input__box">
										<label>First Name <span>*</span></label>
										<input type="text" id="fname" name="fname" title="Enter first name" required>
									</div>
									<div class="input__box">
										<label>Last Name<span>*</span></label>
										<input type="text" id="lname" name="lname" title="Enter last name" required>
									</div>
									<div class="input__box">
									...
									<div class="input__box">
										...
										<input type="text" id="loc" name="loc" title="Fill out your location" required>
									</div>
									<div class="input__box">
									...
									<div class="input__box">
										...
										<label>
											...
											Female:<input type="radio" name="gender" id="fmale">
											Other:<input type="radio" name="gender" id="other">
										</label>
									</div>
									<div class="input__box">
										<label>Date of Birth<span>*</span></label>
										<input type="Date" name="DOB" id="DOB" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" title="DD.MM.YYYY" required>
									</div>
									<br>
